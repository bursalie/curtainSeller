...
using Amcacik.Sessions;
using Amcacik.Web.Controllers.Results;
using Amcacik.Web.Models;
using Amcacik.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace Amcacik.Web.Controllers
{
    public class AccountController : AmcacikControllerBase
    {
